                            ...
                            <div className="rounded overflow-hidden shadow-md bg-cybornheader">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="/Srut.png" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-white text-center pb-1">Srut.Sol</div>
                                    <p className="text-white text-sm text-center">Marketing Lead & HR</p>
                                    <p className="text-center text-white text-base pt-3 font-normal">Hire people who are better than you are, then leave them to get on with it. Look for people who will aim for the remarkable, who will not settle for the routine.</p>
