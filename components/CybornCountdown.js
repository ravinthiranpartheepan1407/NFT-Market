...
class CybornCountdown extends Component {
  ...
  render() {
    ...
    <div className="text-white">
        ...
        <br />
        <br />
        <button type="button" class="w-72 h-16 ml-20 text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 shadow-lg shadow-lime-500/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Explore</button>
    </div>
