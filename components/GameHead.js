  ...
  return(
    <nav className='flex items-center flex-wrap bg-cybornheader '>
       ...
       >
         ...
         <button type="button" onClick={()=>router.push("/game/home")} className="text-gray-900 text-gray-900 bg-gradient-to-r from-lime-200 via-lime-400 to-lime-500 font-medium text-sm px-2 py-2 mt-0 text-center w-64 items-center">
            &nbsp; Mint NFT
         </button>
       </div>
     </nav>
